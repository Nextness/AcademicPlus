<<<<<<<< HEAD:academicplus/interface/operations.py
# ===================================================== #
#                 ~~~~ < Imports > ~~~~                 #
# ===================================================== #

import academicplus.Research.Manager as resm
...
def get_monitor_resolution() -> tuple[int]:
    ...
    user32 = ctypes.windll.user32
    return user32.GetSystemMetrics(0), user32.GetSystemMetrics(1)
>>>>>>>> d39f3a1cd4c740e39d4523e310b3d69979c6b16f:src/Interface/Operations.py
